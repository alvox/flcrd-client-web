<template>
    <div class="md:flex md:h-56 text-copy-primary mb-4 mr-4 rounded-lg bg-background-ternary hover:bg-background-hover"
        ...
        <div class="flex-1">
            <div v-if="flashcard.front.startsWith('http')" class="h-full border-2 border-border-primary">
        ...
        <div class="flex-1">
            <div v-if="flashcard.rear.startsWith('http')" class="h-full border-2 border-border-primary border-t-0 md:border-t-2 md:border-l-0">
