<template>
    ...
    <div>
        <div class="mx-auto max-w-2xl rounded-lg mt-10 border-2 border-gray-400 bg-white flex items-center">
            <img class="object-left object-fit m-10" src="../assets/img/undraw_memory_storage.svg" width="200px" height="200px"/>
            <div class="m-10 ml-0 text-gray-800 text-base leading-relaxed">
                <p class>
